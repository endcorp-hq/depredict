...
**Current Implementation:** All positions are minted as NFTs, providing true ownership and enabling secondary market trading.
...
- Manual resolution option for admin-controlled markets

**Current Implementation:** Markets can be configured for either Switchboard oracle resolution or manual resolution by the admin.
