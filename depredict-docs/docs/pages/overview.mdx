...
- **NFT-Powered Positions:** All positions are represented as immutable NFTs using MPL Core.
- **Trading:** Buy and sell YES/NO positions instantly, with automatic token swapping.
- **Resolution:** Settle markets based on real outcomes, with support for Switchboard oracles.
