...
- **Trading:** Buy and sell YES/NO positions instantly, without the need for liquidity.
- **Resolution:** Settle markets based on real outcomes, with support for oracle resolutions.
