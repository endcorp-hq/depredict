...
const POSITION_PAGE_SEED = "pos_page"
const MARKET_SEED = "market"
const MARKET_CREATOR_SEED = "market_creator";

// Export provider, program, and keypairs for use in tests
export { provider, program, ADMIN, FEE_VAULT, METAPLEX_ID, USER, LOCAL_MINT, ORACLE_KEY, BUBBLEGUM_PROGRAM_ID, MPL_CORE_ID, MPL_NOOP_ID, ACCOUNT_COMPRESSION_ID, CONFIG_SEED, MPL_CORE_CPI_SIGNER, MARKET_SEED, MARKET_CREATOR_SEED, POSITION_PAGE_SEED };
