...
export declare const getCollectionPDA: (programId: PublicKey, marketId: number) => PublicKey;
export declare const getPositionNftPDA: (programId: PublicKey, marketId: number, positionId: BN) => PublicKey;
